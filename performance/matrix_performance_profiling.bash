...
unique_id=profile_update_20251222_after_changes # CHANGED from before-case script; typo corrected after running
...
fresh_globus=false # CHANGED from before-case script
# ENDPOINT UUIDS:
